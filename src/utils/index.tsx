...
export async function getTokenPrice(token:any){
    let address;
    if (token.symbol ==='ETH'){
    ...
    const url = 'https://deep-index.moralis.io/api/v2/erc20/'+address+'/price?';
...
export async function getTokenPriceByAddress(address:string){
